...
- ✅ **Catálogo de Medicamentos**: Explora medicamentos disponibles (solo lectura)
...
└── src/
    ...
    │   │   └── index.ts                # Exports
    │   ├── medicamentos/
    │   │   ├── MedicamentosPage.tsx    # Catálogo medicamentos
...
- Solo lectura (sin crear/eliminar)
- Campos: ID, Nombre
...
| GET | `/api/v1/medicamentos/paginated` | Con paginación |
...
| GET | `/api/v1/solicitudes-medicamentos/usuario/{id}` | Del usuario |
| GET | `/api/v1/solicitudes-medicamentos/usuario/{id}/paginated` | Del usuario (paginado) |
